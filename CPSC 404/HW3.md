...
| Sparse (DE per page of records)     | "".                                                                                                                                | ""                                                                                                                                | Good. Can have sparse index because we are guaranteed some order/partitioning of records on disk.                              | Not possible. No guarantee that records are sorted/partitioned physically, so we need a handle on every record.                                                       |
| Alt1 (DEs are physical records)     |                                                                                                                                    |                                                                                                                                   | fine                                                                                                                           | fine                                                                                                                                                                  |
